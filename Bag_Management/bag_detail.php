...
<div class="header-top">
    ...
    <div class="product-info">
        <p style="color: black"><?php echo $obj['bag_name']; ?></p>
...
<a href="product_order.php?id=<?php echo $obj['id']; ?>&quantity=" + document.getElementById('quantity').value" class="btn" type="button" style="background-color: rgba(255,87,34,.1);color: red; border-color: red;">
            <span>Thêm Vào Giỏ Hàng</span>
            </a>

            <a href="Dat_Hang.php?id=<?php echo $obj['id']; ?>&quantity=" + document.getElementById('quantity').value" class="btn btn-danger" type="button">
            <span>Mua Ngay</span>
            </a>
        </div>
    </div>
